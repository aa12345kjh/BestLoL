...
function myCtrl ($scope,$sce) {
  ...
  angular.extend($scope, {
    heros : [
      ...
      {name: '易大師', sts:'JG',img:'http://pic2.52pk.com/files/allimg/140724/2D0S4_203HUE6.png',
        text:'易大師jg!!(後期秒殺bd角)一大師這角色雖然最近因為燈籠的nerf沒在那麼強,但改回以前出蜥蜴刀,他還是有大的作用,只要抓好q的時機和w的時機,他是可以製造出很大的傷害的!'
            +'<br/><br/>天賦易大天賦沒什麼特別的21 9 0即可,軍閥可以只點1點即可,可拿來點咒力施放,武力全開召喚師技能重擊 + 傳送：小心被反野,但比較好做分推重擊 + 閃現：追擊一些位移能力強的後排閃現比較重要裝備買蜥蜴刀是因為我覺得現今版本的燈籠已經沒那麼強了,所以改回買蜥蜴刀,一開始要買黃色的視頻,以免吃第2個buff被些強勢的jg蹲先把蜥蜴刀和妖刀出出來搭配妖主動記爆發很猛cp直很高出完妖刀可自行選擇要先上殞落還是耳語看是血厚還是防高,大順風就可直接上無盡了,防裝也可以選擇女妖技能3等如果沒要Gank可點q'
            +'<br/><br/>雙重打擊（被動）：每攻擊幾次後，易大師將會進行2次打擊。先聲奪人（Ｑ）：易大師快速穿越戰場對敵人造成傷害，對路徑上多個目標造成物理傷害並對士兵和野怪造成額外傷害。先聲奪人可以對野怪與士兵暴擊和造成額外物理傷害。普攻可以減少先聲奪人的冷卻時間。'
            +'<br/><br/>易大師飛速穿越戰場，對最多 4 位敵人造成 25/60/95/130/165 （+） 物理傷害，另外對士兵和野怪造成 75/100/125/150/175 傷害。先聲奪人可以造成暴擊，造成額外 物理傷害。普攻命中減少此技能 1 秒冷卻時間。'
            +'<br/><br/>冥想（Ｗ）：易大師進入冥想狀態，持續回復生命，同時短暫減少傷害。'
            +'<br/><br/>易大師進入冥想狀態，每秒回復 30/50/70/90/110 （0.3） 生命，持續 4 秒。 易大師失去 1% 生命治癒效果就會提升 1%。當進入冥想狀態時，易大師減少50/55/60/65/70% 所受傷害。減少傷害百分比對上防禦塔則會減半。'
            +'<br/><br/>無極劍（Ｅ）：易大師精通深奧的無極之道，提高物理攻擊。主動使用技能時，加倍提高物理攻擊，普攻將獲得額外真實傷害，但被動所獲得額外傷害在技能冷卻時不會提供任何增益效果。 被動： 獲得 10/10/10/10/10% （） 物理傷害。主動： 普攻造成額外 10/15/20/25/30 （+） 真實傷害，持續 5/5/5/5/5 秒。 在無極劍道冷卻時間中，被動獲得的額外物理傷害將會消失。高原血統（Ｒ）：易大師以靈巧的步伐進行移動，短暫提高跑速和攻速，同時免疫全部的緩速效果。主動使用技能時，擊殺英雄或助攻可以延長高原血統的作用時間。處於被動時，擊殺或助攻可以減少易大師其他技能的冷卻時間。 被動： 擊殺英雄和助攻將會減少 70% 易大師技能冷卻時間。主動： 增加 25//45% 跑速，增加 30/55/80% 攻速，並獲得緩速免疫效果，持續 10/10/10 秒。當主動效果啟動時，英雄擊殺和助攻將會延長高原血統的作用時間 4/4/4 秒。敵對英雄李星　難度：★★★★現今版本強勢的jg之一. 第一輪的第2個buff小心被蹲,被蹲到殺到可能會一蹶不振,差眼防範或者call其他路來支援伊莉絲　難度：★★★★現今版本強勢的jg之一, 雖然之前nerf過了,但是一波傷害還是很夠,也是注意一開始不要被蹲嘉文四世　難度：★★最近比賽出場率越來越高,野區撞到只要小心別被e.q戳到還ok伊芙琳　難度：★★★★我覺得有點麻煩的jg,畢竟會隱形,三線都會有壓力,也是第一輪第2個buff要小心點,有的人會帶點燃,被蹲到幾乎都會死沃維克　難度：★★★他沒什麼,他一開始都會先農為主,農到6點才開始gank,一開始在野區撞到也別他打 打不贏,他2等q.w單挑打不贏,但是他很少會蹲趙信　難度：★★★3等傷害爆高的jg,被蹲也會很慘,遇到他別打,w的時機很重要費德提克　難度：★★★★應打他打不贏,小心被恐,被恐到打不贏,賈克斯　難度：★★★可以說是易大剋星之1,但是只要好好運用q可以閃掉e,在他e的時候開w等他要暈你的時候q,就打得贏附註易大初期是一隻在野區撞到很多都打不贏的英雄, 但他只有在對的時間出現收到一次頭很容易就起飛, 但還是要注意進場時機,我覺得他最大的技巧就是q的時機和w的時機, 在對的時間點開可以很好塔殺人,或者大反殺裝備:功速鞋>軍隊長劍(嗜魂)>鬼刀>無盡>殞落>耳語or復活甲'},
      
      {name: '特朗德', sts:'TOP',img:'http://kiwame-z.com/wp-content/uploads/2014/10/f483afdc8fa3667f273471b2b5223c5d.png',  text:'這是誰'},
      
      {name: '布朗姆', sts:'SUP',img:'http://img.legames.cn/templates/images/upload/2014/07/1405329974_0.png',text:''},
      ...
      {name: '厄薩斯', img:'http://i.gbc.tw/2010/zone/lol/champion/120/aatrox.png',text:''},
